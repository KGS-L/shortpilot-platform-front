...
import { BarChart3, BriefcaseBusiness, CircleDollarSign, CreditCard, Film, HeartHandshake, LayoutDashboard, LogOut, Radio, Send, Settings, ShieldCheck, Users, Workflow } from "lucide-react";
import { cn } from "@/lib/utils";

export type Space = "user" | "partner" | "admin";
const navigation = {
  user:["Mon espace",[["Vue d’ensemble","/dashboard",LayoutDashboard],["Vidéos","/dashboard/videos",Film],["Publications","/dashboard/publications",Send],["Connexions","/dashboard/integrations",Radio],["Facturation","/dashboard/billing",CreditCard],["Analyses","/dashboard/analytics",BarChart3]]],
