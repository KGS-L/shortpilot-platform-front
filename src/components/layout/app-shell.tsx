  ...
  return <div className="flex min-h-screen bg-[#f5f7fb]">
    ...
    <div className="min-w-0 flex-1">
      <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b bg-white/90 px-4 backdrop-blur sm:px-5 md:px-8">
        <div className="flex items-center gap-3"><MobileNavigation space={space}/><Link href="/" className="font-black lg:hidden">Short<span className="text-lime-600">Pilot</span></Link><span className="hidden text-sm font-semibold text-slate-500 sm:block">{labels[space]}</span></div>
